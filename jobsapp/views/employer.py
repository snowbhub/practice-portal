...
class DashboardView(ListView):
    model = Job
    template_name = 'practice/employer/dashboard.html'
...
class ApplicantPerJobView(ListView):
    model = Applicant
    template_name = 'practice/employer/applicants.html'
...
class JobCreateView(CreateView):
    ...
    extra_context = {
        'title': 'Post New practice'
    }
    success_url = reverse_lazy('practice:employer-dashboard')
...
class ApplicantsListView(ListView):
    model = Applicant
    template_name = 'practice/employer/all-applicants.html'
    context_object_name = 'applicants'

    def get_queryset(self):
        # practice = Job.objects.filter(user_id=self.request.user.id)
...
def filled(request, job_id=None):
    ...
    job.filled = True
    job.save()
    return HttpResponseRedirect(reverse_lazy('practice:employer-dashboard'))

class JobUpdateView(SuccessMessageMixin, UpdateView):
    model=Job
    template_name = 'practice/update_job.html'
